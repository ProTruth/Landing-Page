...
const styles = {
  ...
  colors: {
    'dark/zinc': [
      ...
      'dark:text-white dark:[--btn-bg:theme(colors.zinc.600)] dark:[--btn-hover-overlay:var(--color-white)]/5',
    ...
    zinc: [
      'text-white [--btn-hover-overlay:var(--color-white)]/10 [--btn-bg:theme(colors.zinc.600)] [--btn-border:theme(colors.zinc.700/90%)]',
